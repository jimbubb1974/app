...
export function TimescaleDialog() {
  ...
  return (
    ...
    >
        ...
        <Stack direction="column" spacing={2} mt={1}>
          <FormControl size="small" fullWidth>
            ...
            <Select
              ...
              label="Top Row"
              value={top}
              onChange={(e) => setTimescale(e.target.value as any, bottom)}
            >
          ...
          <FormControl size="small" fullWidth>
            ...
            <Select
              ...
              label="Bottom Row"
              value={bottom}
              onChange={(e) => setTimescale(top, e.target.value as any)}
            >
              <MenuItem value="month">Month</MenuItem>
      ...
      <DialogActions>
        <Button onClick={() => setTimescaleOpen(false)} variant="contained">
          Close
        </Button>
      </DialogActions>
    </Dialog>
