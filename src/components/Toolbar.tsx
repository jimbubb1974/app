...
export function Toolbar() {
  ...
  return (
    ...
    >
      ...
      <Button size="small" variant="contained" sx={{ bgcolor: "#34495e" }}>
        Export
      </Button>
      <Button size="small" variant="contained" sx={{ bgcolor: "#34495e" }}>
        Save Config
      ...
      <Button size="small" variant="contained" sx={{ bgcolor: "#34495e" }} onClick={() => zoom(0.8)}>
        Zoom In
      </Button>
      <Button size="small" variant="contained" sx={{ bgcolor: "#34495e" }} onClick={() => zoom(1.25)}>
        Zoom Out
      </Button>
      <Button size="small" variant="contained" sx={{ bgcolor: "#34495e" }} onClick={fitAll}>
        Fit All
      </Button>
      <Divider
        flexItem
